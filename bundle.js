System.registerDynamic("npm:my-name-is-url@1.4.0/dist/parser.js", ["npm:my-name-is-url@1.4.0/dist/regex.js"], true, function ($__require, exports, module) {
  /* */
  'use strict';
  ...
  var _regex = $__require("npm:my-name-is-url@1.4.0/dist/regex.js");
...
System.registerDynamic("npm:tlds@1.203.1/index.js", [], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  /* */
...
System.registerDynamic("npm:tlds@1.203.1.js", ["npm:tlds@1.203.1/index.js"], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  module.exports = $__require("npm:tlds@1.203.1/index.js");
});
System.registerDynamic('npm:my-name-is-url@1.4.0/dist/regex.js', ['npm:tlds@1.203.1.js'], true, function ($__require, exports, module) {
  /* */
  'use strict';
  ...
  var _tlds = $__require('npm:tlds@1.203.1.js');
...
System.registerDynamic('npm:my-name-is-url@1.4.0/dist/my-name-is-url.js', ['npm:my-name-is-url@1.4.0/dist/parser.js', 'npm:my-name-is-url@1.4.0/dist/regex.js'], true, function ($__require, exports, module) {
  /* */
  'use strict';
  ...
  var global = this || self,
      GLOBAL = global;
  Object.defineProperty(exports, "__esModule", { value: true });
  var _parser = $__require('npm:my-name-is-url@1.4.0/dist/parser.js');
...
System.registerDynamic("npm:my-name-is-url@1.4.0.js", ["npm:my-name-is-url@1.4.0/dist/my-name-is-url.js"], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  module.exports = $__require("npm:my-name-is-url@1.4.0/dist/my-name-is-url.js");
});
...
System.register('src/main.js', ['npm:my-name-is-url@1.4.0.js', 'npm:escape-html@1.0.3.js', 'npm:strict-uri-encode@1.1.0.js'], function (_export) {
  'use strict';
  ...
  function checkInput() {
    ...
    var parsedUrls = Urls(input.value).filter(function (url) {
      return '!urlMatchStart' + url + '!urlMatchEnd';
    });
    ...
    parsedUrls = parsedUrls.replace(/!urlMatchStart/g, '<span class="url">').replace(/!urlMatchEnd/g, '</span>');
  ...
  // Run on page load
  return {
    setters: [function (_npmMyNameIsUrl140Js) {
      Urls = _npmMyNameIsUrl140Js['default'];
    }, function (_npmEscapeHtml103Js) {
      escape = _npmEscapeHtml103Js['default'];
    }, function (_npmStrictUriEncode110Js) {
      strictUriEncode = _npmStrictUriEncode110Js['default'];
    }],
    execute: function () {
      ...
      defaultText = 'Text to parse for urls.com';
      hashText = decodeURIComponent(location.hash.substring(1));

      input.value = hashText || defaultText;checkInput();
